...
namespace CoAP.Examples
{
    class TestCoap
    {
        public static void ss(String[] args)
        {
            ...
            args = new String[] { "GET", "coap://[aaaa::33]/voltage" };
            // args = new String[] { "GET", "coap://[2001:2::ff]/temperature" };
            //  args = new String[] { "GET", "coap://[2001:2::ac]/light" };
                ...
                if (byEvent)
                {
                    request.Responded += delegate(Object sender, ResponseEventArgs e)
                    {
                        ...
                        else
                        {
                            ...
                            string ss = response.PayloadString;
